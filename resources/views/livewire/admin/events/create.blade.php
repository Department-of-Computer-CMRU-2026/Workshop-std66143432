<div>
    <div class="page-header">
        <div>
            <div class="page-title">➕ เพิ่มกิจกรรมใหม่</div>
            <div class="page-sub">กรอกรายละเอียดหัวข้อ Workshop</div>
        </div>
            ...
            <form wire:submit="save">
                <div class="form-group">
                    ...
                    <input wire:model="title" type="text" class="form-input"
                        placeholder="เช่น Modern Web Development with React">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input wire:model="speaker" type="text" class="form-input" placeholder="ชื่อวิทยากร">
                        @error('speaker') <div class="form-error">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">สถานที่ *</label>
                        <input wire:model="location" type="text" class="form-input" placeholder="เช่น ห้อง A101">
